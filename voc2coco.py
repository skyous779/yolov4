...
def convert(xml_list, json_file, jpg_src_path, jpg_save_path, pre_define_categories, only_care_pre_define_categories = True):
    ...
    for index, line in enumerate(xml_list):
        ...
        image_id = index
        shutil.copy(os.path.join(jpg_src_path, filename), os.path.join(jpg_save_path, filename))
...
if __name__ == '__main__':
    ...
    # 训练数据的josn文件
    save_json_train = '../data_1220/train.json'
    # 验证数据的josn文件
    save_json_val = '../data_1220/val.json'
    
    # # 验证数据的test文件
    # save_json_test = './data/coco/test.json'
...
#     print('xml_list is {}'.format(xml_list))
    ...
    xml_list_train = xml_list[val_num:]
    # xml_list_test = xml_list[train_num+val_num:]  
    # 对训练数据集对应的xml进行coco转换   
    convert(xml_list_train, save_json_train,'../data_1220/train', '../data_1220/train_coco', pre_define_categories)
    # 对验证数据集的xml进行coco转换
    convert(xml_list_val, save_json_val, '../data_1220/train', '../data_1220/val_coco', pre_define_categories)
    # 对测试数据集的xml进行coco转换
    # convert(xml_list_test, save_json_test, './data/JPEGImages', './data/test_coco', pre_define_categories)